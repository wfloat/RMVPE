...
# RUN python3 -m pip install --no-cache-dir -r requirements.txt # TODO
...
RUN aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main/rmvpe.pt -d weights/ -o rmvpe.pt
